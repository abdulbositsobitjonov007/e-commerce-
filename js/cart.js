...
let finalprice = 0;
    ...
    data.map((el) => {
        content.innerHTML +=
            `
    <div class="flex flex-col sm:flex sm:flex-row gap-[10px] h-full w-full mt-[30px] max-w-[1300px] h-[72px] bg-[white] justify-between rounded-[5px] shadow-md hover:shadow-orange-300 duration-400">
                    <div class="flex items-center gap-[10px]">
                        ...
                        <div class="flex flex-col">
                            ...
                            <span class="flex gap-[10px]">
                                ...
                                <p class="text-[white] whitespace-nowrap left-[10px] bottom-[10px] px-[8px] py-[4px] bg-[#FF6633] rounded-[4px]">-${el.discount}%</p>
                            </span>
                        </div>
                    </div>
                    <div class="flex justify-between items-center pr-[10px] gap-[20px] lg:gap-[30px] xl:gap-[56px]">
